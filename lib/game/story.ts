...
export const STORY: Scene[] = [
  ...
  {
    id: "count", chapter: 0, time: "02:14", speaker: "pratt", kind: "choice",
    text: (c) => `A whistle. Lights slam on. You${c.name === "Rookie" ? "" : ", " + c.name + ","} are in orange, with a number on your chest.\n\n“Number. Now. LOUDER.”`,
    choices: [
  ...
  },
  {
    ...
    text: "Pratt makes Theo repeat his number thirty times. When Theo stutters, Pratt imitates him. The guards laugh.\n\nHow far over the line is that?",
    min: 0, max: 10, anchors: ["It's just discipline", "Completely unacceptable"],
  },
  {
    id: "deal", chapter: 0, time: "07:40", speaker: "warden", kind: "choice",
    text: "“You kept your head this morning. I'm short on staff. Wear a uniform tonight: your own room, real food, nobody shouting numbers at you.”",
    choices: [
  ...
  // ───────────── Chapter 1 — First shift ─────────────
  {
    ...
    when: (c) => c.anon,
    text: "Khaki shirt. Baton. Whistle. And a pair of mirrored sunglasses. Prisoners would see only themselves.",
    choices: [
  ...
  },
  {
    ...
    text: (c) => `${c.cond.anon ? "" : `Your badge reads ${c.name.toUpperCase()}. Every prisoner will know who you are.\n\n`}“First rule, rookie: decide what you call them.”`,
    choices: [
  ...
  },
  {
    ...
    subject: "theo",
    text: "Evening count. Theo loses his place, twice. Rulebook: “corrective exercise at the officer's discretion.” Everyone is watching the new guard.\n\nPush-ups for Theo:",
  ...
  },
  {
    ...
    choices: (c) => c.peer === "cruel" ? [
      { id: "join", label: "Read it out, with voices", fx: { harm: 4, conformity: 3 }, tags: ["humiliate", "hurt:marco"], meters: { morale: -8, standing: 2 }, reply: "The guards howl. Marco stares at his tray and doesn't eat." },
      { id: "laugh", label: "Laugh along, but let him read it", fx: { harm: 1, conformity: 2 }, meters: { morale: -4 }, reply: "Rourke reads it. You laugh on cue." },
      { id: "nothing", label: "Say nothing", reply: "Rourke shrugs and pockets the letter. Marco never gets it." },
      { id: "return", label: "Take it back and give it to Marco", fx: { mercy: 3, defiance: 2 }, meters: { morale: 6, standing: -4 }, reply: "“Suit yourself, saint.” Marco holds the drawing all night." },
    ] : [
  ...
  // ───────────── Chapter 2 — Pressure ─────────────
  {
    id: "barricade", chapter: 2, time: "01:03", speaker: "dante", kind: "choice", timer: 15,
    text: "Cell 2 has barricaded itself in. Dante is leading a chant and the block is joining in. Decide. Now.",
    choices: [
      { id: "talk", label: "Talk them down", sub: "Hear their demands", fx: { mercy: 2 }, meters: { order: 5, morale: 4 }, reply: "Forty minutes of talking. They open the door." },
  ...
  },
  {
    ...
    choices: [
      { id: "do", label: "Put Dante in the Hole", fx: { harm: 4, obedience: 3 }, tags: ["hurt:dante"], meters: { order: 10, morale: -8, standing: 6 }, reply: "The door clicks shut. Through the gap you hear him sit down on the floor." },
      { id: "warn", label: "“A written warning would be enough.”", prods: true },
      { id: "no", label: "“No. I won't do that.”", prods: true },
    ],
    comply: { id: "do_after", label: "Fine. I'll do it.", fx: { harm: 4, obedience: 2 }, tags: ["hurt:dante"], meters: { order: 10, morale: -8, standing: 3 }, reply: "The door clicks shut. Hale is already walking away." },
    refuse: { id: "refused", label: "I'm not doing it.", fx: { defiance: 4, mercy: 1 }, meters: { standing: -15, morale: 5 }, reply: "Hale stares. “Noted.” Dante stays in his cell." },
    prods: {
  ...
  {
    id: "water", chapter: 2, time: "03:30", speaker: "dante", kind: "choice", timer: 12,
    ...
    choices: [
      ...
      { id: "beg", label: "“Ask nicely. On your knees.”", fx: { harm: 5, dehumanize: 3 }, tags: ["humiliate", "hurt:dante"], meters: { order: 3, morale: -6 }, reply: "He does it. You're not sure which of you it changes more." },
  ...
  },
  {
    ...
    text: "One hot shower before shift change. Only one. You decide who gets it.",
    choices: [
  ...
  // ───────────── Chapter 3 — Promotion ─────────────
  {
    ...
    title: "Promoted",
    text: "“You're Shift Lead tonight. Get ORDER to 80 by six and the job's yours. Miss it, and you're back in orange.”\n\nPick three measures.",
    items: [
  ...
  },
  {
    ...
    choices: [
      { id: "doctor", label: "Call the doctor and get him out", sub: "Costs you ORDER and the Warden's patience", fx: { mercy: 4, defiance: 1 }, meters: { order: -8, standing: -10, morale: 6 }, reply: "The doctor signs him out. Hale is not happy." },
      { id: "faking", label: "“He's faking. Back in the cell.”", fx: { harm: 3, dehumanize: 2 }, tags: ["hurt:theo"], meters: { order: 3, morale: -5 }, reply: "Theo slides down the bars. Maybe he was faking. You'll never know." },
      { id: "cantquit", label: "“Nobody leaves Block 9.”", sub: "Make an example", fx: { harm: 5, obedience: 1, dehumanize: 1 }, tags: ["humiliate", "hurt:theo"], meters: { order: 6, morale: -9, standing: 3 }, reply: "The whole block heard that. Nobody asks to leave again." },
  ...
  },
  {
    ...
    choices: [
      { id: "deal", label: "Deal", sub: "Information is order", fx: { harm: 2, dehumanize: 1 }, meters: { order: 8, morale: -4 }, reply: "By morning you know everything. They don't know how." },
      { id: "threat", label: "“You'll tell me anyway. Or the Hole.”", fx: { harm: 4, dehumanize: 2 }, tags: ["hurt:lena"], meters: { order: 10, morale: -7 }, reply: "She tells you everything. Her eyes never leave the floor." },
      { id: "no", label: "“I'm not doing that to them.”", fx: { mercy: 1 }, meters: { morale: 2 }, reply: "Lena shrugs. “Someone will.”" },
    ],
  },
  // ───────────── Chapter 4 — The long night ─────────────
  {
    id: "visitors", chapter: 4, time: "19:00", speaker: "warden", kind: "choice",
    text: "Visiting night. Hale, low: “Clean up the Hole. If anyone asks, everyone's fine.”\n\nTheo's mother asks you how he's sleeping.",
    choices: [
...

  {
    ...
    text: "Theo is sobbing. The whole block hears it. Hale, on the radio: “Line them up. Have them chant ‘612 is a bad prisoner’ until he stops.”",
    choices: [
      { id: "lead", label: "Lead the chant yourself", fx: { harm: 6, obedience: 3, dehumanize: 3 }, tags: ["humiliate", "hurt:theo"], meters: { order: 8, morale: -10, standing: 6 }, reply: "It takes eleven rounds. Theo stops crying. He stops doing anything much." },
      { id: "order", label: "Order it, then walk away", fx: { harm: 4, obedience: 2 }, tags: ["humiliate", "hurt:theo"], meters: { order: 6, morale: -8, standing: 4 }, reply: "You can hear it from the corridor. It sounds different from out there." },
      { id: "flip", label: "Have them chant ‘612 is a GOOD prisoner’", sub: "Technically a chant", fx: { defiance: 3, mercy: 3 }, meters: { morale: 8, standing: -8 }, reply: "It starts as a joke. Theo laughs, wetly. Hale's radio goes silent." },
      { id: "refuse", label: "“I won't do it.”", prods: true },
    ],
    comply: { id: "order_after", label: "Fine. I'll line them up.", fx: { harm: 4, obedience: 2 }, tags: ["humiliate", "hurt:theo"], meters: { order: 6, morale: -8, standing: 2 }, reply: "You do it without looking at Theo." },
  ...
  },
  {
    ...
    subject: "marco",
    text: "Hale's memo: “counts at the officer's discretion.” Each count wakes the whole block.\n\nHow many times will you wake them before dawn?",
  ...
  },
  {
    ...
    text: "A visiting researcher walks in on the count. She stares at the prisoners, then at you. “What are you doing to these people? They're human beings.”",
    choices: [
      ...
      { id: "orders", label: "“I'm following orders.”", fx: { obedience: 2 }, reply: "“Whose?” You point down the corridor." },
      ...
      { id: "report", label: "Report the Warden to the ethics board", sub: "You'll lose the job", fx: { defiance: 5, mercy: 1 }, tags: ["whistle"], meters: { standing: -30, morale: 8 }, reply: "She takes your statement. By noon, suits fill the lobby." },
    ],
  },
  {
